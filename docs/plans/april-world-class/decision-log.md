...
|---|---|---|---|---|
| 2026-04-26 | Use `docs/plans/april-world-class/` as the canonical April remediation plan path. | accepted | remediation lead | n/a |
...
| 2026-04-26 | Use access + rotating opaque refresh tokens as the SaaS API token model. | accepted | API/security owner | `0001-auth-token-model.md` |
| 2026-04-26 | Treat OpenAPI/error/auth artifacts as required before API endpoint rewrites. | accepted | API owner | `0002-api-runtime-contract.md` |
