          ...
          <div class="card-body">
            ...
            <form action="./sign-in.php" method="POST" autocomplete="off">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="username" class="form-control" placeholder="Enter your username" autocomplete="off" required value="<?php echo htmlspecialchars($_POST['username'] ?? ''); ?>" />
              </div>
              ...
              <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                  <input type="password" name="password" id="password" class="form-control" placeholder="Your password" autocomplete="off" required />
