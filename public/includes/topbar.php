...
<header class="navbar navbar-expand-md d-print-none">
  <a href="#main-body" class="visually-hidden-focusable position-absolute seeder-skip-link">Skip to main content</a>
      ...
      <div class="nav-item dropdown">
        <button type="button" class="nav-link d-flex lh-1 text-reset p-0 border-0 bg-transparent" data-bs-toggle="dropdown" aria-label="Account menu">
          ...
          <div class="d-none d-xl-block ps-2">
            <div class="seeder-account-name"><?php echo htmlspecialchars(getSession('full_name') ?: getSession('username') ?: 'User'); ?></div>
